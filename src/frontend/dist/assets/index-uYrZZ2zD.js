...
function getCoordinatesInBothFormats(lat, lon) {
...
function formatFullIndiaAddress(address) {
  ...
  const parts = [];
  if (villageEng == null ? void 0 : villageEng.trim()) parts.push(`${safeUpper(villageEng)} VILLAGE`);
  if (mandalEng == null ? void 0 : mandalEng.trim()) {
    const cleanMandal = mandalEng.toUpperCase().replace(/\s+MANDAL$/, "");
    parts.push(`${cleanMandal} MANDAL`);
  }
  if (districtEng == null ? void 0 : districtEng.trim()) {
    const cleanDistrict = districtEng.toUpperCase().replace(/\s+DISTRICT$/, "");
    parts.push(`${cleanDistrict} DISTRICT`);
  }
  if (stateEng == null ? void 0 : stateEng.trim()) {
  ...
  if (parts.length === 0 && address.display_name) {
    ...
    if (displayName == null ? void 0 : displayName.trim()) parts.push(safeUpper(displayName));
  }
  let out = parts.length > 0 ? parts.join(", ") : "Location details not available.";
  if (pin) {
    out += `, PIN: ${pin} (INDIA).`;
...
function showNotification(message, type = "success") {
  ...
  setTimeout(() => notification.classList.remove("show"), 2e3);
}
...
function updateGoogleMap(lat, lon, zoomLevel = zoom) {
  currentLat = lat;
  currentLon = lon;
  zoom = zoomLevel;
...
function generateReferenceNumber() {
  ...
  lastRefGenerationTime = now2.getTime();
  updateRefDisplay();
  return refNumber;
}
...
function updateRefDisplay() {
  ...
  if (refValue)
    refValue.textContent = (refInput ? refInput.value : "") || "Ref.No. 05-01-2026 20.49/1";
}
function updateLocationDisplay() {
  ...
  if (locationValue)
    locationValue.textContent = (locationInput ? locationInput.value : "") || "Fetching...";
}
...
function copyCoordsManual() {
  ...
  if (!coords) return;
  navigator.clipboard.writeText(coords).then(() => showNotification("Copied", "success")).catch(() => showNotification("Failed", "error"));
}
function copyAllDetails() {
  ...
  const location2 = locationInput ? locationInput.value.trim() : "";
...
function shareOnWhatsApp() {
  ...
  const gmap = getGoogleMapsLink(currentLat, currentLon);
  const distances = calculateDistances();
  const message = `📍 *Coordinates:* ${encodeURIComponent(coords)}%0A🔗 *Google Map:* ${encodeURIComponent(gmap)}%0A📋 *Reference:* ${encodeURIComponent(ref)}%0A🏢 *Location:* ${encodeURIComponent(location2)}%0A📏 *${encodeURIComponent(distances.hyderabad)}*%0A📏 *${encodeURIComponent(distances.nalgonda)}*`;
...
function App() {
  const [maxMap, setMaxMap] = reactExports.useState(true);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `container${maxMap ? " max-map" : ""}`, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "left-panel", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "title-section", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "GPRS ALL - MAP VIEWER" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "subtitle", children: "Google Maps & Bhuvan Integration" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "coordsInput", children: "ENTER GPS COORDINATES" }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "button-grid", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: "⬅️ Show Panel"
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "refInput", children: "REFERENCE NAME/NO." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { htmlFor: "locationInput", children: "LOCATION DETAILS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "map-section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "map-wrapper", id: "mapWrapper", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "iframe",
          {
            id: "mapFrame",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ref-display", id: "refDisplay", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ref-title", children: "REFERENCE NAME/NO." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "ref-value", id: "refValue", children: "Ref.No. 05-01-2026 20.49/1" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "location-display", id: "locationDisplay", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "location-title", children: "LOCATION DETAILS" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "location-value", id: "locationValue", children: "Fetching..." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "site-location-display", id: "siteLocationDisplay", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "site-location-title", children: "SITE LOCATION" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "site-location-value", id: "siteLocationValue", children: "17.068839, 79.258973" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "distance-display", id: "distanceDisplay", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "distance-title", children: "DISTANCE FROM CITIES" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "distance-value", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "distance-from", id: "distanceHyderabad", children: "Hyderabad: --.-- km" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "distance-from", id: "distanceNalgonda", children: "Nalgonda: --.-- km" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "zoom-controls", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whats-here-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whats-here-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-title", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "📍 What's Here" }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whats-here-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whats-here-coords", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-label", children: "COORDINATES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-value", id: "whatsHereCoords", children: "17.068839, 79.258973" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "whats-here-address", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-label", children: "LOCATION DETAILS" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-value", id: "whatsHereAddress", children: "Fetching..." }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-label", style: { marginTop: "12px" }, children: "GOOGLE MAP LINK" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-value", id: "whatsHereGmap", children: "--" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "whats-here-footer", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-info-content", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-info-header", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-info-title", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bhuvan-icon-large", children: "🛰️" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Bhuvan Map" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-info-body", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-coords-display", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bhuvan-coords-label", children: "SITE LOCATION COORDINATES" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bhuvan-coords-value", id: "bhuvanCoordsValue", children: "17.068839, 79.258973" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "site-location-label", children: "SAME AS GOOGLE MAPS" })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-instructions", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "instructions-title", children: "📋 Instructions:" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "instructions-list", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Copy coordinates for Bhuvan Map" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Open Bhuvan website in new tab" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Paste coordinates in Bhuvan search" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: "Coordinates match Google Maps" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bhuvan-info-footer", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "notification", id: "notification", children: "Coordinates copied!" })
  ] });
}
...
Service({
  "addCoordinate": Func([Float64, Float64, Text], [], []),
  "deleteCoordinate": Func([Nat], [], []),
  "getAllCoordinates": Func([], [Vec(Coordinate)], ["query"]),
  "getCoordinate": Func([Nat], [Coordinate], ["query"])
});
