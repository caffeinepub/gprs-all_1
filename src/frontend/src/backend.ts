...
export class Backend implements backendInterface {
    ...
    async addCoordinate(arg0: number, arg1: number, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addCoordinate(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async deleteCoordinate(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.deleteCoordinate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCoordinate(arg0: bigint): Promise<Coordinate> {
        if (this.processError) {
            try {
                const result = await this.actor.getCoordinate(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
